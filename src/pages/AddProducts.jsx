  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        setFormData({ title: '', description: '', category: '', price: '', image: '' }); // Reset form
      }
    } catch (error) {
      setMessage({ type: 'danger', text: error.response?.data?.message || 'Failed to add product. Please try again.' });
    } finally {
      setLoading(false);
    }
  };
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  ...
                  {formData.title.length > 0 && formData.title.length <= 5 && 
                    <div className="invalid-feedback">Title must be greater than 5 characters.</div>
                  }
                </div>
                ...
                <div className="mb-3">
                  ...
                  {formData.description.length > 0 && formData.description.length <= 5 && 
                    <div className="invalid-feedback">Description must be greater than 5 characters.</div>
                  }
                </div>
                ...
                <div className="mb-3">
                  ...
                  />
                  {formData.category.length > 0 && formData.category.length <= 5 && 
                    <div className="invalid-feedback">Category must be greater than 5 characters.</div>
                  }
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    ...
                    />
                    {formData.image.length > 0 && formData.image.length <= 5 && 
                      <div className="invalid-feedback">Image URL must be greater than 5 characters.</div>
                    }
                  </div>
                </div>
