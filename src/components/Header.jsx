      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/increement">Increment</Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/context">Context API</Link>
            </li>
            <li className="nav-item">
          ...
          <form className="d-flex align-items-center" role="search" onSubmit={(e) => e.preventDefault()}>
            <button 
              className={`btn btn-sm me-2 btn-outline-${theme === 'dark' ? 'light' : 'dark'}`}
              type="button" 
              onClick={toggleTheme}
            >
